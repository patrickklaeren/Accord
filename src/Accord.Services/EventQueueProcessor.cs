                        ...
                        IRequest<ServiceResponse> action = queuedItem switch
                        {
                            ...
                            AddUserReportInboxMessageEvent addMessage
                                => new AddUserReportMessageRequest(addMessage.DiscordGuildId, addMessage.DiscordMessageId, addMessage.DiscordUserId,
                                    addMessage.DiscordChannelId, UserReportChannelType.Inbox, addMessage.DiscordMessageContent, addMessage.Attachments, addMessage.QueuedDateTime),

                            AddUserReportOutboxMessageEvent addMessage
                                => new AddUserReportMessageRequest(addMessage.DiscordGuildId, addMessage.DiscordMessageId, addMessage.DiscordUserId,
                                    addMessage.DiscordChannelId, UserReportChannelType.Outbox, addMessage.DiscordMessageContent, addMessage.Attachments, addMessage.QueuedDateTime),
